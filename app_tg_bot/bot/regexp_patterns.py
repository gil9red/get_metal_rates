...
if __name__ == '__main__':
    ...
    assert fill_string_pattern(PATTERN_INLINE_GET_AS_CHART, -1, 'gold') == 'get_last_-1_as_chart=gold'
    assert fill_string_pattern(PATTERN_INLINE_GET_AS_CHART, 31, 'gold') == 'get_last_31_as_chart=gold'
